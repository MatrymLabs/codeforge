...
from parts.world.items import ITEMS, carrier
from parts.world.party import members_in_room, party_of
from parts.world.session import SESSIONS, display_name, sentence_case
...
def assign_drop(killer_id: str, room: str, iid: str) -> str | None:
    ...
    if len(eligible) < 2:  # solo here: leave it on the floor to be taken (unchanged behavior)
        return None
