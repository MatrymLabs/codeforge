...
def list_item(session: Session, arg: str) -> str:
    ...
    from parts.world import auction_store, climate
...
def buy(session: Session, id_word: str) -> str:
    ...
    from parts.world import auction_store
    from parts.world.characters import _default_store, reclone_item, save_character
...
def sweep_expired() -> int:
    ...
    from parts.world import auction_store, climate, mail_store
