...
def main(argv: list[str] | None = None) -> int:
    ...
    Usage:
      python3 -m parts.seedlab.kernel create <name> <owner> [purpose]
      python3 -m parts.seedlab.kernel list
      python3 -m parts.seedlab.kernel status <seed_id>
      python3 -m parts.seedlab.kernel start|stop|archive <seed_id> <actor>
    """
    import sys
