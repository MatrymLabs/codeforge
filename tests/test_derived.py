"""Test twin for kernel/world/derived.py -- the prototype derived-stat formulas.
...
from kernel.world.derived import DERIVED_STATS, derived_stats
...
def test_derived_stats_uses_the_active_world_ruleset(monkeypatch) -> None:
    ...
    import kernel.world.derived as derived  # noqa: PLC0415, PLR0402
    from kernel.world.stat_rules import from_dict  # noqa: PLC0415
