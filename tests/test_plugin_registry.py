"""Test twin for kernel/shelf/plugin_registry.py -- explicit registration, capabilities, disable."""

import pytest

from kernel.shelf.plugin_registry import PluginError, PluginInfo, PluginRegistry
