"""Test twin for kernel/shelf/weighted_table.py -- weighted selection with an injected RNG.
...
from kernel.shelf.weighted_table import WeightedTable, WeightedTableError
