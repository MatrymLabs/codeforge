"""Test twin for kernel/classroom.py -- Professor Codex and the lesson loop.
...
from kernel.assessment import find_lesson
from kernel.classroom import _ACHIEVEMENTS, _LEARNERS, demonstrated
