"""Test twin for kernel/world/engineer.py -- the Engineer's combat kit, all deterministic.
...
from kernel.world import engineer, npcs
from kernel.world.engineer import (
    analyzed_duration,
    deploy_barrier,
    diagnostic_scan,
    emergency_repair,
