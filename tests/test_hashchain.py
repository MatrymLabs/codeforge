"""Test twin for kernel/shelf/hashchain.py -- the general tamper-evident append-only ledger.
...
from kernel.shelf.hashchain import GENESIS, HashChainError, append, content_hash, read, verify
