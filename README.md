...
highest bar: coverage floor 85%), every dimension green. The table is **generated by the
tool, not hand-written** - regenerate it yourself (volatile numbers stay on the live badges,
so nothing here can silently drift):
