...
def emit() -> None:
    ...
    wild: list[str] = [
        ...
        "# zone's level band and biome (parts/world/wildlands.py).",
        "",
    ]
    settles: list[str] = [
        ...
        "# with residents and a merchant at the settlement's level band (parts/world/townsfolk.py).",
        "",
    ]
    delves: list[str] = [
        ...
        "# of escalating foes ending in a deep boss, at the dungeon's level band (parts/world/delve.py).",
        "",
    ]
    ways: list[str] = [
        ...
        "# pay a fee to travel to any other, at the destination's level band (parts/world/travel.py).",
        "",
    ]
