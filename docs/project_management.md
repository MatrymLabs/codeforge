...
| R4 | **EvidenceGate `truth check`** command **(DONE 2026-07-09)** - automate the manual truth audit (README/docs/registry claims) | truth prompt; composes `docs_check` + registry validate | P2 | S |
