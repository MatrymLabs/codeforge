...
needed (the Forgeward Road, the bounty board). The flagship **`aethryn`** seed is the first, playable
...
4. **Exits that mean something** — every exit is a real choice; a dead-end is a *destination* (a
   ...
   the eastward run carries the Forgeward Road and downward exits carry the Cinderdeep.
...
its bottom, the Reachwood, the Cooling-Sea port, the local Ashwaste, and the Forgeward Road's procedural
run east to the Sovereign. A complete cradle-to-Forge game, L1-300. *This is the proof and the pattern.*
...
Reaches (L40-60, L50-70) and the on-ramp to the overland endgame. The Sundered Sky's Highgate is the
door to the Forgeward Road proper.

**Phase 6 - the deep and the frontier: the Cinderdeep expansion and the outer Forgeward Road.** The
two frontiers grow without end, the deep downward and the Road eastward toward the Forge, the First
Seed, and the endgame choice.
...
- **Way-shrines & mage-portals** — personal, costly, restricted; the recovered fragments of the lost
  True Translation.
- **Frontier ways** - the Coilfoot and the marches east along the Forgeward Road, the Cinderdeep
  mouths down; progression, not convenience.
...
- **The Main Campaign** - the Emberwright Rememberers' spine: gather the scattered craft, run the
  Forgeward Road east, hunt the Seed-Shards, face the endgame choice. Answered in pieces, re-opened by expansions.
...
- **The Forgeward Road** - the overland run east to the Forge, an elemental gauntlet of themed marches
  to the Sovereign at the Forge's Edge and beyond, toward the raw Kindling where the world's laws go soft.
...
- **Ancient Rituals & Raids** - multi-Forger works: relight a dead capital, seal a Reach's Unforging,
  open a sealed waystation, magic that takes a guild.
...
Long Cinder a dungeon-age), **each faction a questline**, and the Forgeward Road runs on eastward while
the Cinderdeep deepens without end. New Reaches ship new cultures, ecosystems, jobs, and relics; the world's central argument
