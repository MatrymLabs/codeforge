...
| catalog search (`reuse_search`) | 39 ms | serialization (repeated YAML parse) | `regression_detected` vs intent (see EXP-001) |
...
- Catalog/registry search: median <= 5 ms (baseline 39 ms) - **currently over**; EXP-001 targets it.
