...
| Sparse event-driven control plane | Wake only the subsystems an event touches; bounded queues; interrupt lane for security/policy | **Extrapolation** | High / Medium - Build now | `parts/world/events.py` | Srivatsav et al. (2023); Su et al. (2024); Frank et al. (2025) |
