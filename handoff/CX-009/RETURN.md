...
commands_run:
  ...
  - command: make check
    exit_code: 0
    output: >
      ruff format check passed (1067 files), ruff check passed, import contracts 4 kept 0 broken,
      mypy succeeded on 807 source files, and the complete 5251-test pytest gate passed.
  - command: >
