...
A cast (kernel/cast.py) vendors the engine as a FROZEN snapshot of codeforge@<commit>. Over time the
...
def _default_validator(cast_dir: Path) -> tuple[bool, str]:
    """The real re-validation: boot the updated cast and run its command corpus (kernel.cast)."""
