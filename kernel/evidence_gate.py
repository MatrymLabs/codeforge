...
from kernel.hardware import source_gaps, uncataloged_cores
from kernel.integrity import overclaim_hits, presence_gaps
...
def main() -> int:
    """CLI entry (`python -m kernel.evidence_gate`, `make truth`): render the audit and GATE.
