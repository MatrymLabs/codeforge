...
from kernel.world.combat_clock import (
    advance as tick,
...
def diagnostic_scan(session: Session, word: str) -> str:
    ...
    from kernel.world.combat import elemental_profile  # lazy: engineer sits above the combat loop  # noqa: E501, I001, PLC0415
