...
is testable without a boot, and it is what kernel.world.wildlands hangs in each generated room.
"""
...
def make_notable(biome: str, level: int, idx: int, room: str, seq: int) -> Npc:
    ...
    sixth a boss), non-ambient so it mints a hunt bounty (kernel.world.quest.register_bounties),
