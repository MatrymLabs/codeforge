...
class Session:
    ...
    # (kernel.world.afflictions.tick_afflictions), transient, never persisted.
    ...
    # so the once-a-day cap survives logout (kernel.world.lockouts).
    ...
    # player, like a gather node; transient, not persisted (kernel.world.shrine).
    ...
    # governs. Level derives from practice (kernel.world.professions.level_for); persisted per hero.
    ...
    # from the number (kernel.world.reputation). Persisted per hero.
