...
The forge (kernel/world/caves.py) makes an area; this is where it waits between generation and
...
# The mutating half of the `world` command family (the read-only half is kernel/world/survey.py).
