...
Reactive combat (kernel.world.combat) answers a player's blow. Aggression is its other
...
from kernel.world.session import SESSIONS, Session, sentence_case
...
# resets the count (kernel.world.combat.attack), so a real fight keeps the foe engaged.
LEASH = 5
