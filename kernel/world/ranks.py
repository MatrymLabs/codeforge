...
(python3 -m kernel.world.characters grant <name> owner). Physical access
...
from kernel.world.events import SHUTDOWN, announce, broadcast
...
def teleport(session: Session, word: str) -> str:
    ...
    # (kernel.world.workshop). Players cannot teleport at all; a wizard is turned back here.
