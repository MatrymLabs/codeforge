...
goes through the safe command relay (`kernel/shelf/console.py`); anything that would EDIT files is
...
from kernel.hardware import catalog_text, load_catalog, part_haystack
