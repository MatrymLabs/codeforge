...
DEFAULT_PLAN: tuple[FilePlanRule, ...] = (
    ...
    FilePlanRule(
        "fp.manifest",
        "a language-appropriate package manifest is present",
        "any_of",
    ...
    FilePlanRule(
        ...
        "any_of",
        ("SECURITY.md", "SECURITY.rst", ".github/SECURITY.md"),
        "warn",
        1.0,
    ),
    FilePlanRule(
        "fp.lockfile",
        "a dependency lockfile pins versions for reproducible installs",
        "any_of",
        ("uv.lock", "poetry.lock", "package-lock.json", "pnpm-lock.yaml", "go.sum", "Cargo.lock"),
        "warn",
        1.0,
    ),
)
