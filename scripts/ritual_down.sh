...
# --- 3. DOUSE THE EMBERS ---------------------------------------------------
rm -f /tmp/ritual-spark.log /tmp/ritual-check.log /tmp/ritual-bandit.log /tmp/ritual-audit.log /tmp/ritual-readiness.log /tmp/ritual-secrets.log 2>/dev/null || true
